...
$l['lm_host'] = 'Hostnaam';
$l['lm_ips'] = 'IPs';
$l['lm_hvmsettings'] = 'VPS Configuratie';
...
$l['page_of'] = 'of';
$l['page_go'] = 'Ga';
$l['build_no_vs'] = 'De VPS Werd niet gevonden in de Database';
...
$l['build_no_ip'] = 'De primaire IP ontbreekt voor de VPS';
...
$l['xen_err_lvm'] = 'Er was een fout bij het maken van de LVM van de VPS';
$l['xen_err_swap'] = 'Er is een fout opgetreden in het creëren van de SWAP van de VPS';
$l['xen_err_tmp'] = 'Er is een fout opgetreden in het creëren van de Mount Point';
$l['xen_err_mount'] = 'r is een fout opgetreden bij het mounten van de VPS LVM';
$l['xen_err_unmount'] = 'Er is een fout opgetreden in het unmounten van de VPS LVM';
$l['xen_err_dd'] = 'Er is een fout opgetreden tijdens het installeren van de VPS';
$l['xen_err_mkfs'] = 'Er is een fout opgetreden tijdens het formatteren van de VPS';
$l['xen_err_mkswap'] = 'Er is een fout opgetreden tijdens het formatteren van de SWAP van de VPS';
...
$l['kvm_err_lvm'] = 'Er was een fout bij het maken van de LVM van de VPS';
$l['kvm_err_mount'] = 'Er is een fout opgetreden bij het monteren van de VPS LVM';
$l['kvm_err_unmount'] = 'Er is een fout opgetreden in het unmounten van de VPS LVM';
$l['kvm_err_dd'] = 'Er is een fout opgetreden tijdens het installeren van de VPS';
...
$l['kvm_err_mkswap'] = 'Er is een fout opgetreden tijdens het formatteren van de SWAP van de VPS';
