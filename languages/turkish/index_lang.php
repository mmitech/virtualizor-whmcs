...
$l['err_locked_vps'] = 'VPS is locked, hence no actions are allowed to perform';
...
$l['dock_restart'] = 'VPS Tekrar Başlat';
$l['dock_stop'] = 'VPS Durdur';
$l['dock_start'] = 'VPS Başlat';
$l['dock_poweroff'] = 'VPS Kapat';
...
$l['lm_hvmsettings'] = 'VPS Yapılandırması';
...
$l['build_no_vs'] = 'VPS Veritabanında Bulunamadı';
...
$l['build_no_ip'] = 'VPS için Ana IP Belirtilmemiş';
...
$l['xen_err_lvm'] = 'VPS’nin LVM’sini Oluştururken Bir Hata Oluştu';
$l['xen_err_swap'] = 'VPS’nin SWAP’ını Oluştururken Bir Hata Oluştu';
$l['xen_err_tmp'] = 'Mount Noktası Oluştururken Bir Hata Oluştu';
$l['xen_err_mount'] = 'VPS LVM Bağlanırken (mount)  Edilirken Bir Hata Oluştu';
$l['xen_err_unmount'] = 'VPS LVM Bağlantı Kesilirken  (unmount)  Edilirken Bir Hata Oluştu';
$l['xen_err_dd'] = 'Disk Kopyalama İşlemi Sırasında Bir Hata Oluştu';
$l['xen_err_mkfs'] = 'VPS Formatlarken Bir Hata Oluştu';
$l['xen_err_mkswap'] = 'VPSnin SWAP Formatlanırken Bir Hata Oluştu';
...
$l['xcp_err_vdi'] = 'VPSin VDIsi Oluşturulurken Bir Hata Oluştu';
$l['xcp_err_iso'] = 'ISO Yüklenirken Bir Hata Oluştu';
$l['xcp_err_vif'] = 'VPS İçin VIF Oluşturulurken Bir Hata Oluştu';
$l['xcp_xentools_missing'] = 'Xentools ISO Bulunamadı';

// KVM VPS Creation errors
$l['kvm_err_lvm'] = 'VPS’nin LVM’sini Oluştururken Bir Hata Oluştu';
$l['kvm_err_mount'] = 'VPS LVM Bağlanırken (moount) Bir Hata Oluştu';
$l['kvm_err_unmount'] = 'VPS LVM nin Bağlatısı Kesilirken  (unmount) Bir Hata Oluştu';
...
$l['kvm_err_mkswap'] = 'VPS’nin SWAP’ını Biçimlendirirken Bir Hata Oluştu';
...
$l['lxc_err_unmount'] = 'VPS LVM nin Bağlatısı Kesilirken  (unmount) Bir Hata Oluştu';
...
$l['lxc_err_mount'] = 'VPS LVM Bağlanırken Bir Hata Oluştu';

// Virtuozzo VPS Creation errors
$l['virtuzo_create_error'] = 'VPS Oluşturulurken Bir Hata Oluştu';
$l['err_vncpass'] = 'VNC Şifresi Ayarlanırken Bir Hata Oluştu';
$l['err_set_iso'] = 'ISO’yu VPS’ye Takmada Bir Tane Vardı';
$l['err_disk_create'] = 'VPS Diski Oluşturulurken Bir Hata Oluştu';
...
$l['openvz_err_create'] = 'VPS Oluşturulurken Bir Hata Oluştu';
...
$l['vps_is_suspended'] = 'Bu VPS Askıya Alındı. VPS İçin Hiçbir İşlem Yapamazsınız. !';
$l['suspend_reason_bw'] = 'Bu VPS, Bant Genişliği Kullanım Nedeniyle Askıya Alındı. VPS İçin Hiçbir İşlem Yapamazsınız. !';

$l['unknown'] = 'Bilinmiyor';
$l['change_onboot'] = 'VPS Yeniden Boot Edildiginde Değişiklik Gerçekleşecek.';
$l['completed'] = 'Tamamlandı';
$l['vpsdisk_resize_err'] = 'Diskleri Yeniden Boyutlandırırken Bir Hata Oluştu';
$l['mount_undetermined'] = 'VPSde Hiçbir Linux Bölümü Bulunamadı';
$l['disk_destroy_err'] = 'Diskleri Silerken Bir Hata Oluştu';
$l['started'] = 'Başladı';
$l['ended'] = 'Bitti';
$l['updated'] = 'Güncenlendi';
$l['edit_xcperror'] = 'VPSi Düzenlemeye Çalışırken Bir Hata Oluştu';
$l['bandwidth_threshold_mail_sub'] = 'Bant Genişliği  Aşıldı';
$l['bandwidth_threshold_mail_message'] = 'Merhaba,

 VPSiniz {{hostname}} Aylık trafik Limiitini {{vps_bandwidth_threshold}} % Geçmiştir.

VPSiniz  Bant Genişliği  limitinızin {{limit_gb}} GB tından   {{used_gb}} GB  Trafik Kullanmıştır . 

Saygılarla,
{{sn}}';

$l['bandwidth_mail_sub'] = ' VPS  Bant Genişliği Aşırı Kullanımı nedeniyle Askıya Alıdı VPS';
$l['bandwidth_mail_message'] = 'Merhaba,

 VPSiniz `{{hostname}}` Askıya Alındı, çünkü Aylı kBant Genişliği sınırınızı aştınız.

VPSiniz  {{used_gb}} GB Trafik kullandı. Fakat Aylık Bant Genişliği limitiniz {{limit_gb}} GB. 

Saygılarla,
{{sn}}';

$l['speed_capped_mail_sub'] = 'VPS Ağ Hızı, Bant Genişliği aşırı kullanımı nedeniyle sınırlandı';
$l['speed_capped_mail_message'] = 'Merhaba,

VPSiniz  {{hostname}} AĞ Hızı Bant Genişliği aşırı kullanımı nedeniyle sınırlandı
...
$l['removed_speed_capped_mail_sub'] = 'VPS AĞ Hızı geri yüklendi';
$l['removed_speed_capped_mail_message'] = 'Merhaba,

VPS {{hostname}} Ağ Hızı sınır limitiniz kaldırıldı.  Ağ Hızınız Eski değerler yüklendi

VPSiniz  {{used_gb}} GB Bant Genişliği kullandı. Aylık Bant Genişliği limitiniz {{limit_gb}} GB.
...
VPSiniz {{vpsid}} Yaman Ayarınız ({{time}}) da işlem {{action}} başladı. 
';
...
$l['exp_speed_cap_down'] = 'Bant genişliği VPS için aşırı kullanıldıktan sonra indirme hızı, 0 veya boş değer sınırlama olmadığını gösterir';
$l['speed_cap_up']= 'Limitlenrilmiş Upload Hızı ';
$l['exp_speed_cap_up'] = 'Bant Genişliği VPS için aşırı kullanıldıktan sonra yükleme hızı, 0 veya boş değer sınırlama olmadığını gösterir';
...
$l['inv_winpass_chars'] = 'Windows VPS ROOT Şifresi İçin İzin Verilen Özel Karakterler :';
...
$l['vm_locked_backup'] = 'VPS backup is running';
$l['vm_locked_restore'] = 'VPS restore is running';
